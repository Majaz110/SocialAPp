...
namespace API.Controllers
{
    ...
    public class MessagesController : BaseApiController
    {
        ...
        public async Task<ActionResult<IEnumerable<MessageDto>>> GetMewssageThread(string username)
        {
        ...
        public async Task<ActionResult> DeleteMessage(int id)
        {
            ...
            if(message.Sender.UserName == user) message.SenderDeleted = true;

            if(message.Recipient.UserName == user) message.RecipientDeleted = true;
